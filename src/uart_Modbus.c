    ...
    if (uart0_filestream != -1)
    {
        ...
        while(1){
            ...
            // memcpy(&tempInt, &rx_buffer[3], sizeof(float));
              ...
              switch (rx_buffer[0]) {
            case 0xA1:
                // código para a ação correspondente ao comando 0xA1
                break;
            case 0xA2:
                // código para a ação correspondente ao comando 0xA2
                break;
            case 0xA3:
                // código para a ação correspondente ao comando 0xA3
                break;
            // adicionar mais casos para os outros comandos
            default:
